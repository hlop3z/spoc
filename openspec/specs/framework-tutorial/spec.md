...
The end-to-end tutorial contract: the documentation demonstrates — not merely
asserts — that a developer can author a small working framework on the kernel,
and the test suite holds the demonstration true. This is the north-star claim
("simple enough to build a framework on") converted from a slogan into an
executable page.
